      ...
      <div class="mx-auto max-w-lg">
        ...
        @csrf
          ...
          <div id="info_yape" class="hidden text-center">
            <h3 class="text-md font-semibold text-gray-900 dark:text-white">Escanea para Pagar (Yape)</h3>
            <img src="{{ asset('imagenes/i__principal/QR.png') }}" alt="Código QR Yape"
              class="mx-auto mt-2 h-[150px]" />
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Envía la captura de pantalla al WhatsApp.</p>
          </div>

          <button type="submit"
            class="mt-4 w-full bg-pink-500 rounded-lg px-5 p-3 hover:bg-pink-600  font-medium text-white">
            COMPRAR
          </button>
