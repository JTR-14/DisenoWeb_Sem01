  ...
  <main>
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <section class="text-center">
        ...
        <p class="mx-auto text-sm mt-4 max-w-md text-gray-500 dark:text-gray-400" data-translate="descripcion_arreglos">
          "Descubre nuestra exclusiva colección de arreglos de rosas eternas, diseñados para capturar la belleza y el
          amor que perduran para siempre. Perfectos para regalar en ocasiones especiales o para decorar tu hogar con un
