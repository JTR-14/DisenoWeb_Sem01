<x-layout>
  ...
  <main class="max-w-2xl mx-auto text-start p-4 sm:p-6 lg:p-8 leading-relaxed">
    <h4 class="font-bold text-2xl mt-4 text-gray-900 dark:text-white text-center" data-translate="contact_title">
    ...
    <div
      ...
      <label data-translate="contact_email">Correo electrónico:</label>
      ...
      <br>
      <label for="email" data-translate="contact_phone">Número Telefónico:</label>
      ...
      <div class="flex items-center gap-4 mt-2">
        <a class="text-gray-900 dark:text-white transition hover:text-gray-900/75 dark:hover:text-white/75" href="#"
          target="_blank">
