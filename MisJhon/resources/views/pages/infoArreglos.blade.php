    ...
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div class="mt-9 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-16 place-items-center">
        <p class="mt-4 text-gray-700 dark:text-gray-300 text-justify p-4" data-translate="ia1">
          ...
          especial que les permite mantener su forma, color y suavidad por años, sin necesidad de agua o luz solar. Cada
          arreglo es una obra única, diseñada y elaborada a mano con un cuidado y una atención al detalle que reflejan
          el valor de lo artesanal. Con ellas, puedes celebrar un momento especial y atesorar su belleza como un
          recuerdo duradero.
        </p>
        ...
        <p class="mt-4 text-gray-600 dark:text-gray-400 text-justify" data-translate="ia2">
          ...
          una alternativa sostenible y duradera a las flores tradicionales, permitiéndote regalar belleza sin límites de
          tiempo. Te invitamos a explorar nuestra galería y a encontrar el arreglo que hable por sí mismo, convirtiendo
          un simple regalo en un símbolo de amor y aprecio que durará por años.
        </p>
      </div>
    </div>
  </main>
