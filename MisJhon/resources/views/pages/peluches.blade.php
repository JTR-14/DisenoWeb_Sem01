    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <header class="text-center">
        <div class="flex justify-center gap-6 text-gray-900 dark:text-white">
          <h2 class="text-xl font-bold text-gray-900 dark:text-white sm:text-3xl" data-translate="titulo_peluches">
            Colección de Peluches</h2>
      ...
      <ul class="mt-8 grid gap-4 grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 md:gap-8">
        ...
        <li class="group block overflow-hidden rounded-t-2xl shadow-lg">
          <img src="{{ asset('imagenes/i__peluches/P1.png') }}" alt=""
        ...
        <li class="group block overflow-hidden rounded-t-2xl">
          <img src="{{ asset('imagenes/i__peluches/P2.png') }}" alt=""
            class="h-[250px] w-full object-cover transition duration-500 group-hover:scale-105 md:h-[350px] ">
        ...
        <li class="group block overflow-hidden rounded-t-2xl">
          <img src="{{ asset('imagenes/i__peluches/P3.png') }}" alt=""
            class="h-[250px] w-full object-cover transition duration-500 group-hover:scale-105 md:h-[350px] ">
        ...
        <li class="group block overflow-hidden rounded-t-2xl">
          <img src="{{ asset('imagenes/i__peluches/P4.png') }}" alt=""
            class="h-[250px] w-full object-cover transition duration-500 group-hover:scale-105 md:h-[350px] ">
        ...
        <li class="group block overflow-hidden rounded-t-2xl">
          <img src="{{ asset('imagenes/i__peluches/P5.png') }}" alt=""
            class="rounded-t-3xl h-[250px] w-full object-cover transition duration-500 group-hover:scale-105 md:h-[350px] ">
        ...
        <li class="group block overflow-hidden rounded-t-2xl">
          <img src="{{ asset('imagenes/i__peluches/P6.png') }}" alt=""
            class="h-[250px] w-full object-cover transition duration-500 group-hover:scale-105 md:h-[350px] ">
