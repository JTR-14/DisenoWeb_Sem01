    ...
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div class="mt-9 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-16 place-items-center">
        <p class="mt-4 text-gray-700 dark:text-gray-300 text-justify p-4" data-translate="ip1">
          ...
          puede convertirse en un miembro de la familia, por lo que nos aseguramos de que cada uno cumpla con los más
          altos estándares de calidad y seguridad, diseñados para soportar innumerables horas de juego, abrazos y
          siestas.
        </p>
